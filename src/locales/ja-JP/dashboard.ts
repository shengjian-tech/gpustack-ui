export default {
  ...
  'dashboard.workers.desc': '分散タスクプロセッサー',
  'dashboard.models': 'モデル',
  'dashboard.models.desc': 'デプロイ済みモデルインスタンス',
  'dashboard.deployments': 'Deployments',
  'dashboard.totalgpus': 'GPU数',
  'dashboard.totalgpus.desc': '高速コンピューティングユニット',
  ...
  'dashboard.usage.situation': '使用状況',
  'dashboard.currently.occupied': '現在使用中',
  'dashboard.surplus.use': '利用可能な残容量',
