export default {
  ...
  'playground.params.size.description':
    'The maximum size of the generated image is controlled by the deployment parameters of the model. <a href="https://fedimoss.com/" target="_blank">Refer to this link</a>',
